...
This file exists to bind the Claude CLI to the shared behavior contract defined in `core/AGENTIC_GUIDE.md`.

**For other platforms:**
- Gemini: Create `GEMINI.md` → Load `core/AGENTIC_GUIDE.md`
- Copilot: Create `COPILOT.md` → Load `core/AGENTIC_GUIDE.md`
